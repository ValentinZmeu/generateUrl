 ...
 * @return String
 */
function generateUrl( $str, $baseUrl = '', $removeChars = [] ) {
    // remove unecesary characters
    $str = str_replace($removeChars, '', $str);
    // special chars replacemente
    $specialChars = array(
    ...
    // remove non alphanumeric & dash, chars 
    $str = preg_replace('/[^A-Za-z0-9\-\s]/', '', $str);
    // to lower case
    $str = strtolower($str);

    // set last slash to $baseUrl if needed
